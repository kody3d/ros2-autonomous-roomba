...
class Metaclass_ChargingState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'CHARGE_NONE': cls.__constants['CHARGE_NONE'],
            'CHARGE_RECONDITION': cls.__constants['CHARGE_RECONDITION'],
            'CHARGE_FULL': cls.__constants['CHARGE_FULL'],
            'CHARGE_TRICKLE': cls.__constants['CHARGE_TRICKLE'],
            'CHARGE_WAITING': cls.__constants['CHARGE_WAITING'],
            'CHARGE_FAULT': cls.__constants['CHARGE_FAULT'],
        }

    @property
    def CHARGE_NONE(self):
        """Message constant 'CHARGE_NONE'."""
        return Metaclass_ChargingState.__constants['CHARGE_NONE']

    @property
    def CHARGE_RECONDITION(self):
