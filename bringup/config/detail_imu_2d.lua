...
TRAJECTORY_BUILDER_2D.max_range = 8.0  -- TMiniの最大レンジに合わせて調整（遠すぎるデータを除外）

TRAJECTORY_BUILDER_2D.missing_data_ray_length = 5.
TRAJECTORY_BUILDER_2D.use_imu_data = true
TRAJECTORY_BUILDER_2D.use_online_correlative_scan_matching = true
-- BNO055は高品質なIMUなので、やや長めの時定数を設定
...
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 3.0  -- 5→3 より頻繁なフィルタリング
TRAJECTORY_BUILDER_2D.motion_filter.max_distance_meters = 0.02  -- 0.05→0.02 移動閾値を厳格化
TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = math.rad(0.1)  -- 0.2→0.1度 回転閾値を大幅厳格化
...
POSE_GRAPH.constraint_builder.ceres_scan_matcher.rotation_weight = 20.
